                      ...
                      <div class="tpl-header--title">
                        ...
                        <div class="cta-wrapper">
                          <button class="btn btn-sm btn-outline-dark float-end" data-bs-toggle="offcanvas"   href="#offcanvasExample" role="button" aria-controls="offcanvasExample">
                            <i class='bi bi-plus'></i> Aggiungi intestazione 
                          </button>	  
                                    ...
                                    <select class="form-select form-select-sm" id="intestazione" name="intestazione">
                                      ...
                                      <?php
                                        foreach ($intestazioni as $intestazione) {
                                          echo "<option value='{$intestazione['id']}'>{$intestazione['descrizione']}</option>";
                                        }
                                      ?>
                                    </select>
                                  </div>
    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
      ...
      <div class="offcanvas-body">
        ...
        <table class="table table-sm table-striped " >
          ...
          <tbody>
          <?php foreach ($intestazioni as $intestazione) { ?>
            <tr>
              <td><?php echo $intestazione['descrizione']; ?></td>
              <!-- Aggiungi il listener per l'evento click all'icona del cestino -->
              <td style="width:20px"><i class='bi bi-trash' onclick="deleteIntestazione('<?php echo $intestazione['id']; ?>')"></i></td>
            </tr>
          <?php } ?>  
          </tbody>
        </table>
