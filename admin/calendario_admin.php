...
$query2 = "
SELECT soc.nome_societa as casa, soc2.nome_societa as ospite, s.golCasa, s.golOspiti, s.giornata, s.id, s.data, s.played
FROM `partite` s
INNER JOIN societa soc ON soc.id = s.squadraCasa
INNER JOIN societa soc2 ON soc2.id = s.squadraOspite
WHERE (squadraCasa = '$societa_id' OR squadraOspite = '$societa_id')
AND s.id_stagione = 11
";

$amichevoli = mysqli_query($con, $query2);
if (!$amichevoli) {
    die('Errore nella query: ' . mysqli_error($con));
}
?>
                  ...
                  <div class="container-fluid">
                    ...
                    <div class="">
                      ...
                      <div class="row g-5 mb-3">
                          ...
                          <table class="table  table-hover table-striped table-rounded">
                            <thead class="table-dark ">
                              ...
                              <tr>
                                ...
                                <th class="text-center" width="2%">Data</th>
                                <th class="text-center" >Orario</th>
                            ...
                            <tbody class="">
                              <?php while($row = mysqli_fetch_assoc($coppa_marche)) {  ?>
                                <tr class="">
                                  ...
                                  <td class="text-center">
                                    <small class="text-center">
                                      <?php echo date('H:i', strtotime($row['ora_match'])) ?>
                                    </small>
                                  </td>
                                  <!-- Squadra casa -->
                        ...
                        <div class="col-12 col-lg-6 table-responsive">
                          <span class="fs-2">Amichevoli</span>
                          <table class="table  table-hover table-striped table-rounded">
                            <thead class="table-dark">
                            ...
                            <tbody class="">
                              <?php while($row = mysqli_fetch_assoc($amichevoli)) {  ?>
                                <tr class="">
                                  ...
                                  <!-- Squadra ospite -->
                                  <td class="text-center  text-nowrap">
                                    <div class="<?= $row['ospite'] === 'VALMISA FUTSAL A.S.D.' ? 'fw-bold' : 'text-dark'?>">   <?php echo $row['ospite'] ?></div>
                                  </td>
              ...
              <div class="row mb-3">
                <div class="col-12">
                  ...
                  <select class="form-select" name="stagione" id="stagione">
                    <!-- Opzioni per la squadra ospite -->
                    <?php
                      $sql = "SELECT * FROM `stagioni` ORDER BY anno_fine DESC, anno_inizio DESC, descrizione ASC, girone ASC";
