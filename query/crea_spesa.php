<?php
  ...
  $destinatario = mysqli_real_escape_string($con, $_REQUEST['destinatario']);
  ...
  $sql = "INSERT INTO uscite (importo, destinatario, giustificativo, mese_competenza)
          VALUES (?, ?, ?, ?)";

  if ($stmt = mysqli_prepare($con, $sql)) {
      // Associa i valori ai segnaposto
      mysqli_stmt_bind_param($stmt, "dsss", $importo, $destinatario, $motivazione, $mese_competenza);
