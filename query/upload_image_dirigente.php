...
$query = "SELECT nome, image_path FROM dirigenti WHERE id = '$id'";
$result = mysqli_query($con, $query);
$player = mysqli_fetch_assoc($result);

$nome_giocatore = $player['nome'];
    ...
    if (in_array($file_ext, $valid_extensions)) {
        ...
        if ($file_size <= $max_size) {
            ...
            if (move_uploaded_file($file_tmp, $target_file)) {
                ...
                $update_query = "UPDATE dirigenti SET image_path = '" . $id . "_" . $file_name_sanitized . "." . $file_ext . "' WHERE id = '$id'";
