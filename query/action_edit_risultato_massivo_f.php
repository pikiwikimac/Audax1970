...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_societa = $_POST['id_societa_ospite'];
    ...
    foreach ($_POST as $key => $value) {
        ...
        if (strpos($key, 'golF-') === 0 || strpos($key, 'gialloF-') === 0 || strpos($key, 'rossoF-') === 0) {
            ...
            if (strpos($key, 'golF-') === 0) {
                $tipo_statistica = 'marcatori';
            } elseif (strpos($key, 'gialloF-') === 0) {
                $tipo_statistica = 'ammoniti';
            } elseif (strpos($key, 'rossoF-') === 0) {
